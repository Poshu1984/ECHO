...
3. Required secrets (set in Cursor Cloud Agents Secrets, never in git): `GOOGLE_TTS_API_KEY`, `JWT_SECRET`, `ECHOO_ADMIN_USER`, `ECHOO_ADMIN_PASSWORD`, `FRONTEND_URL`. Optional: `ANTHROPIC_API_KEY`, `GOOGLE_GEMINI_API_KEY`.
