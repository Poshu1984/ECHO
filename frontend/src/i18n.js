...
const dict = {
  zh: {
    ...
    micBusy: "麥克風正被其他程式使用。",
    chatWait: "老師正在回…",
    micBtHint: "說完放開就送出。老師講完會自動再聽。藍牙耳機請等老師說完再接話。",
  ...
  en: {
    ...
    chatWait: "The tutor is answering…",
    micBtHint: "Release to send. After the tutor speaks, the mic listens again. With Bluetooth, wait until they finish.",
...
Object.assign(dict.ja, {
  ...
  micBtHint: "離して送信。先生のあと自動で聞きます。Bluetoothは話し終わるまで待ってください。",
  newPassage: "別の文章",
  newScene: "別の場面",
  newExample: "別の例文",
...
Object.assign(dict.ko, {
  ...
  micBtHint: "놓으면 전송. 선생님이 말한 뒤 다시 듣습니다. 블루투스는 말이 끝날 때까지 기다리세요.",
  newPassage: "다른 글",
  newScene: "다른 상황",
  newExample: "다른 예문",
...
Object.assign(dict.fr, {
  ...
  micBtHint: "Relâchez pour envoyer. Le micro réécoute après le tuteur. En Bluetooth, attendez la fin.",
...
Object.assign(dict.es, {
  ...
  micBtHint: "Suelta para enviar. El micrófono vuelve a escuchar después del tutor. Con Bluetooth, espera a que termine.",
